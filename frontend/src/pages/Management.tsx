...
export default function Management() {
  ...
  if (isLoading) return <main className="flex min-h-[60dvh] items-center justify-center"><div className="text-center text-slate-500"><div className="mx-auto h-10 w-10 animate-spin rounded-full border-4 border-emerald-500 border-t-transparent" /> <p className="mt-4">در حال بارگذاری مرکز مدیریت...</p></div></main>;
