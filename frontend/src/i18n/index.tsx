...
const dictionaries: Record<Locale, Dictionary> = {
  fa: {
    ...
    "home.buyFromShop": "خرید از فروشگاه", "home.farmersMarket": "بازار غرفه‌داران",
    ...
    "shop.allProducts": "همه محصولات فروشگاه", "shop.backToAll": "بازگشت به همه محصولات",
    ...
    "direct.actions": "گزینه‌های پیام", "direct.reply": "پاسخ", "direct.copy": "کپی متن", "direct.delete": "حذف",
    "direct.replyingTo": "پاسخ به", "direct.editing": "ویرایش پیام", "direct.editPlaceholder": "متن جدید پیام...",
    "direct.edited": "پیام ویرایش شد.", "direct.editedMark": "ویرایش‌شده", "direct.copied": "متن پیام کپی شد.",
    "direct.deleted": "این پیام حذف شد", "direct.deletedToast": "پیام حذف شد.",
    "direct.deleteTitle": "حذف این پیام؟", "direct.deleteHint": "پیام برای هر دو طرف حذف می‌شود و به‌جای آن «پیام حذف شد» نمایش داده می‌شود.",
    "direct.viewListing": "مشاهده آگهی",
    "direct.channelsHint": "منبع پیام",
  ...
  en: {
    ...
    "home.buyFromShop": "Buy from shop", "home.farmersMarket": "Sellers' market",
    ...
    "shop.allProducts": "All shop products", "shop.backToAll": "Back to all products",
    ...
    "direct.actions": "Message options", "direct.reply": "Reply", "direct.copy": "Copy text", "direct.delete": "Delete",
    "direct.replyingTo": "Replying to", "direct.editing": "Edit message", "direct.editPlaceholder": "New message text...",
    "direct.edited": "Message edited.", "direct.editedMark": "edited", "direct.copied": "Message text copied.",
    "direct.deleted": "This message was deleted", "direct.deletedToast": "Message deleted.",
    "direct.deleteTitle": "Delete this message?", "direct.deleteHint": "It is removed for both sides and replaced with a \"message deleted\" placeholder.",
    "direct.viewListing": "View listing",
    "direct.channelsHint": "Source",
  ...
  ar: {
    ...
    "home.buyFromShop": "اشترِ من المتجر", "home.farmersMarket": "سوق البائعين",
    ...
    "shop.allProducts": "كل منتجات المتجر", "shop.backToAll": "العودة إلى كل المنتجات",
    ...
    "direct.actions": "خيارات الرسالة", "direct.reply": "رد", "direct.copy": "نسخ النص", "direct.delete": "حذف",
    "direct.replyingTo": "رد على", "direct.editing": "تعديل الرسالة", "direct.editPlaceholder": "نص الرسالة الجديد...",
    "direct.edited": "تم تعديل الرسالة.", "direct.editedMark": "معدّلة", "direct.copied": "تم نسخ نص الرسالة.",
    "direct.deleted": "تم حذف هذه الرسالة", "direct.deletedToast": "تم حذف الرسالة.",
    "direct.deleteTitle": "حذف هذه الرسالة؟", "direct.deleteHint": "تُحذف للطرفين ويظهر بدلاً منها «تم حذف الرسالة».",
    "direct.viewListing": "عرض الإعلان",
    "direct.channelsHint": "المصدر",
